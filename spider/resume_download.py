...
TARGET_URL = 'http://python.org/ftp/python/2.7.11'
TARGET_FILE = 'Python-2.7.11.tgz'
...
def resume_download():
    ...
    if os.path.exists(TARGET_FILE):
        ...
        # if the file exists, then only download the unfininshed part
        CustomURLClass.addheader('range', 'byte=%s-' % (file_exists))
    else:
